...
-(void) setHeader
{
    [self setCover:@"http://ac-nrth2xb9.clouddn.com/164d2469fbd2c8c7.jpeg"];
    
    [self setUserAvatar:[[AVUser currentUser] objectForKey:@"avatarURL"]];
    
    [self setUserNick:[[AVUser currentUser] objectForKey:@"nickName"]];
    
    [self setUserSign:[[AVUser currentUser] objectForKey:@"signature"]];
}
...
-(void) initData
{
    ...
    textImageItem3.location = @"湖南工业大学";
